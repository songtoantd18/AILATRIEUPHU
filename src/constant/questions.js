import { RandomQuestion, questionsBase } from "./RandomQuestion";

export const questions = RandomQuestion(questionsBase);
...
export const listQuestion = [
  ...
  {
    content: "Đố bạn chuột nào đi bằng 2 chân?",
    answer: [
      {
        option: "A",
        content: "Chuột Logitech",
      },
      {
        option: "B",
        content: "Chuột Không Dây",
      },
      {
        option: "C",
        content: "Chuột Đắk Lắk",
      },
      {
        option: "D",
        content: "Chuột Jerry,Mickey(Nhà em toàn kêu mickey tên chó)",
      },
    ],
  },
  {
    content: "Đố bạn vịt nào đi bằng 2 chân?",
    answer: [
      {
        option: "A",
        content: "Vịt Duck",
      ...
      {
        option: "B",
        content: "Vịt không bị què thì đi bằng 2 chân",
      },
      {
        option: "C",
        content: "Vịt ủn ỉn",
  ...
  },
  {
    ...
    answer: [
      {
        option: "A",
        content: " Anh ta sẽ sút vào bóng",
      },
      {
        option: "B",
        content: "Góc chữ A",
      ...
      {
        option: "D",
        content: "Chết con chim đang bay",
      },
    ],
  },
  {
    content: "Câu hỏi nào mà không ai có thể trả lời “Vâng”?",
    answer: [
      {
        option: "A",
        content: "Tháng sau free tiền học",
      },
      {
        option: "B",
        content: "Tháng sau nữa free tiền học",
      },
      {
        option: "C",
        content: "Tháng sau nữa + 1 free tiền học",
      },
      {
        option: "D",
        content: "Cho tao hôn người yêu mày nhé",
      },
    ],
  },
  {
    content: "Câu đố mẹo có đáp án: Con mèo nào cực kỳ sợ chuột?",
    answer: [
      {
        option: "A",
        content: "Mèo Tom",
  ...
  {
    content: "Where is the correct place to insert a JavaScript?",
    answer: [
      {
        option: "A",
      ...
      {
        option: "D",
        content: "Where cũng được",
      },
    ],
  },
  {
    content: "Thuận có đẹp chai không?",
    answer: [
      {
        option: "A",
        content: "Có",
